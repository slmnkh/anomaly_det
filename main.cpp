...
// decide which are anomalous and compute accuracy
// for each line in
...
//  save_anomalous_transaction_histories();
//	convert_an_tr_file_to_svr_format();
  //    	get_negative_testing_file();
	//  get_negative_model_training_file();
  //  	read_svr_output_compute_results();
	return 0;
}
